...
AUTH0_DOMAIN = os.environ.get('AUTH0_DOMAIN', auth0_params["AUTH0_DOMAIN"])
ALGORITHMS = os.environ.get('ALGORITHMS',auth0_params["ALGORITHMS"])
API_AUDIENCE = os.environ.get('API_AUDIENCE', auth0_params["API_AUDIENCE"] )
...
check_permissions(permission, payload) method
    @INPUTS
        permission: string permission (i.e. 'post:song')
...
@requires_auth(permission) decorator method
    @INPUTS
        permission: string permission (i.e. 'get:song')
